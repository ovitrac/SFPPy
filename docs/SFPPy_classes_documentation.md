...
Generated on: **2025-04-03 00:21:54**
...
| `migrant` | `__init__` | Create a new migrant instance. | 419 | 1.41 |
| `migrant` | `__repr__` | Formatted string representation summarizing key attributes. | 77 | 1.41 |
...
| `migrantToxtree` | `__init__` | migrantToxtree constructor | 41 | 1.41 |
| `migrantToxtree` | `__repr__` | Formatted string representation summarizing key attributes. | 77 | 1.41 |
...
| `migrantToxtree` | `_run_toxtree` |  | 42 | 1.41 |
